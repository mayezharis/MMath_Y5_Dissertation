...
e_data <- read.csv("C:/Users/mayez/OneDrive - University of Edinburgh/Year 5/Dissertation/Code/mmath_dissertation/Shiny App/Datasets/Final Datasets/energydata_complete.csv")
...
write.csv(e_data, "C:/Users/mayez/OneDrive - University of Edinburgh/Year 5/Dissertation/Code/mmath_dissertation/Shiny App/Datasets/final_cleaned_datasets/energy_data_cleaned.csv", row.names=FALSE)
...
write.csv(news_data_cleaned, "C:/Users/mayez/OneDrive - University of Edinburgh/Year 5/Dissertation/Code/mmath_dissertation/Shiny App/Datasets/final_cleaned_datasets/news_data_cleaned.csv", row.names=FALSE)

```

```{r MLB DATA}
mlb_data <- read.csv(unz("C:/Users/mayez/OneDrive - University of Edinburgh/Year 5/Dissertation/Code/mmath_dissertation/Shiny App/Datasets/Final Datasets/game_logs.zip", "game_logs.csv"))
...
write.csv(mlb_data_final, "C:/Users/mayez/OneDrive - University of Edinburgh/Year 5/Dissertation/Code/mmath_dissertation/Shiny App/Datasets/final_cleaned_datasets/mlb_data_cleaned.csv", row.names = FALSE)
...
```{r CRICKET ODI DATA}
odi_data <- read.csv("C:/Users/mayez/OneDrive - University of Edinburgh/Year 5/Dissertation/Code/mmath_dissertation/Shiny App/Datasets/Final Datasets/cricket_odi_data.csv")
...
cric_data_cleaned <- remove_outliers(cric_data_cleaned, names(cric_data_cleaned), lims = c(.25, .75))



write.csv(cric_data_cleaned, "C:/Users/mayez/OneDrive - University of Edinburgh/Year 5/Dissertation/Code/mmath_dissertation/Shiny App/Datasets/final_cleaned_datasets/cric_bat_data.csv", row.names = FALSE)

```

```{r NBA DATA}

nba_data <- read.csv("C:/Users/mayez/OneDrive - University of Edinburgh/Year 5/Dissertation/Code/mmath_dissertation/Shiny App/Datasets/Final Datasets/NBA_Player_Stats.csv")
...
write.csv(nba_data_cleaned, "C:/Users/mayez/OneDrive - University of Edinburgh/Year 5/Dissertation/Code/mmath_dissertation/Shiny App/Datasets/final_cleaned_datasets/nba_data_cleaned.csv", row.names = FALSE)
