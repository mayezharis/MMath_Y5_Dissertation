...
data_all <- list(
  nba_data_cleaned    = read.csv("final_cleaned_datasets/nba_data_cleaned.csv"),
  cric_bat_data       = read.csv("final_cleaned_datasets/cric_bat_data.csv"),
  mlb_data_cleaned    = read.csv("final_cleaned_datasets/mlb_data_cleaned.csv"),
  energy_data_cleaned = read.csv("final_cleaned_datasets/energy_data_cleaned.csv"),
  news_data_cleaned   = read.csv("final_cleaned_datasets/news_data_cleaned.csv")
)
